import{_ as e,o as n,c as i,e as s}from"./app.6f14d96e.js";const a={},l=s(`<h1 id="mysql-\u5B66\u4E60\u7B14\u8BB0\u4E00" tabindex="-1"><a class="header-anchor" href="#mysql-\u5B66\u4E60\u7B14\u8BB0\u4E00" aria-hidden="true">#</a> MySQL \u5B66\u4E60\u7B14\u8BB0\u4E00</h1><h2 id="\u5B50\u67E5\u8BE2" tabindex="-1"><a class="header-anchor" href="#\u5B50\u67E5\u8BE2" aria-hidden="true">#</a> \u5B50\u67E5\u8BE2</h2><p>\u4EC0\u4E48\u662F\u5B50\u67E5\u8BE2</p><blockquote><p>select \u8BED\u53E5\u4E2D\u5D4C\u5957 select \u8BED\u53E5\uFF0C\u88AB\u5D4C\u5957\u7684 select \u8BED\u53E5\u79F0\u4E3A\u5B50\u67E5\u8BE2</p></blockquote><p>\u5B50\u67E5\u8BE2\u53EF\u4EE5\u51FA\u73B0\u5728\u54EA\u91CC\u5462\uFF1F</p><div class="language-mysql ext-mysql line-numbers-mode"><pre class="language-mysql"><code>select
    ...(select)
from
    ...(select)
where
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="2"><li>\u8981\u6C42\u96C6\u5408\u5408\u5E76\u65F6\u5217\u548C\u5217\u7684\u6570\u636E\u7C7B\u578B\u4E5F\u5FC5\u987B\u76F8\u540C</li></ol>`,24),d=[l];function r(c,o){return n(),i("div",null,d)}const u=e(a,[["render",r],["__file","index.html.vue"]]);export{u as default};
